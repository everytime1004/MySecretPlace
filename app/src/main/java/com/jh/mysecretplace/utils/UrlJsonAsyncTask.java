...
public abstract class UrlJsonAsyncTask extends AsyncTask<String, Void, JSONObject> {
    ...
    @Override
    abstract protected JSONObject doInBackground(String... urls);

    @Override
    protected void onPreExecute() {
        if (!this.messageLoading.equals("")) {
            progressDialog = new ProgressDialog(this.activity,
                    android.support.design.R.style.Animation_AppCompat_Dialog);
            progressDialog.setTitle(this.loadingTitle);
            progressDialog.setMessage(this.messageLoading);
            progressDialog.setIndeterminate(true);
//            progressDialog.setIndeterminateDrawable(context.getResources().getDrawable(R.drawable.progress_dialog_loading_icon));
